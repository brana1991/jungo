...
<?php //endif; ?>
    <div class="g-hero__shape js-image-tilt" data-tilt style="background-image: url('<?php the_sub_field('shape_object_image'); ?>')">
      <h1 class"g-hero__title js-title-tilt" data-tilt><?php the_title(); ?></h1>
    </div>
  </div>
